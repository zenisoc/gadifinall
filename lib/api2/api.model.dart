...
List<Usedcar> usedcarFromJson(String str) => List<Usedcar>.from(json.decode(str).map((x) => Usedcar.fromJson(x)));

String usedcarToJson(List<Usedcar> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
