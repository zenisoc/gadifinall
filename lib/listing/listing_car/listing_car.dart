...
class ListingCar extends StatefulWidget {
  @override
  _ListingCarState createState() => _ListingCarState();
}

class _ListingCarState extends State<ListingCar> {
  File _image1;
  File _image2;
  File _image3;
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                      "By Clicking on Post Ad, you accept the Terms of Use, confirm that you will abide by the safety tips, & declare that this post does not include any prohibited items",
                      style: HeadingThreeRegular()),
                )
              ],
            ),
