...
class ListingExcavator extends StatefulWidget {
  @override
  _ListingExcavatorState createState() => _ListingExcavatorState();
}

class _ListingExcavatorState extends State<ListingExcavator> {
  File _image;
